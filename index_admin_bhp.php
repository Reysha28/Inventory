        ...
        <div class="dropdown">
          <button class="ktg">Kategori</button>
            <div class="dropdown-content">
              <a href="index_admin.php">General</a>
              <a href="index_admin_bhp.php">Barang Habis Pakai</a>
              <a href="index_admin_bthp.php">Barang Tidak Habis Pakai</a>
            </div>
        </div>
        <a href="halamaninput.php" class="tbladd" >+ Add</a>
        ...
        <?php
           ...
           ?>
            ...
            <tr>
                ...
                <td>
                    <a class="tbledit" href="halamanedit.php?id=<?php echo $row['kode']; ?>">Update</a> 
                    <a class="tbldelete" href="hapus.php?id=<?php echo $row['kode']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Delete</a>
                </td>
            </tr>
